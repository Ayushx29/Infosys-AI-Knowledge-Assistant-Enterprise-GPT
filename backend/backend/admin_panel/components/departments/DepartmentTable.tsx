...
import { deleteDepartment, getDepartments } from "@/lib/api/api";
...
export default function DepartmentsTable({ search, status }: Props) {
          ...
          render: (value) => (
            <div className="flex gap-2">
              <AlertDialog>
                ...
                <AlertDialogContent className="max-w-md rounded-3xl border p-8 shadow-2xl">
